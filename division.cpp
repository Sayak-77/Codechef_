...
0
Explanation
Example case 1: All integers of the array are divisible by Y = 1 but only A1 = 1 and A2 = 2 are less than or equal to X = 2. 
Hence, the count for the number of integers that are less than or equal to 2 and divisible by 1 is 2.

Example case 2:
Testcase 1: We want to count the number of integers which are less than or equal to X = 10 and divisible by Y = 3. The only integers in the array 
which fit both these criteria are A2 = 6, A4 = 3 and A5 = 9. Since there are three of them, the answer is 3.
Testcase 2: We want to count the number of integers which are less than or equal to X = 10 and divisible by Y = 10. No integer in the array fits both the criteria. 
Since there are no valid integers, the answer is 0. **/
